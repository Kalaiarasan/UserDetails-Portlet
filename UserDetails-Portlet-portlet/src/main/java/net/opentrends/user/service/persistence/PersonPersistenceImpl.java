...
import net.opentrends.user.NoSuchPersonException;
import net.opentrends.user.model.Person;
import net.opentrends.user.model.impl.PersonImpl;
import net.opentrends.user.model.impl.PersonModelImpl;
...
public class PersonPersistenceImpl extends BasePersistenceImpl<Person>
    ...
    public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_UUID = new FinderPath(PersonModelImpl.ENTITY_CACHE_ENABLED,
            ...
            PersonModelImpl.NAME_COLUMN_BITMASK);
    ...
    public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_CITY = new FinderPath(PersonModelImpl.ENTITY_CACHE_ENABLED,
            PersonModelImpl.FINDER_CACHE_ENABLED, PersonImpl.class,
    ...
    public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_CITY = new FinderPath(PersonModelImpl.ENTITY_CACHE_ENABLED,
            PersonModelImpl.FINDER_CACHE_ENABLED, PersonImpl.class,
            FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findBycity",
            new String[] { String.class.getName() },
            PersonModelImpl.CITY_COLUMN_BITMASK |
            PersonModelImpl.NAME_COLUMN_BITMASK);
    public static final FinderPath FINDER_PATH_COUNT_BY_CITY = new FinderPath(PersonModelImpl.ENTITY_CACHE_ENABLED,
            PersonModelImpl.FINDER_CACHE_ENABLED, Long.class,
            FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countBycity",
            new String[] { String.class.getName() });
    private static final String _FINDER_COLUMN_CITY_CITY_1 = "person.city IS NULL";
    private static final String _FINDER_COLUMN_CITY_CITY_2 = "person.city = ?";
    private static final String _FINDER_COLUMN_CITY_CITY_3 = "(person.city IS NULL OR person.city = '')";
     ...
     */
    @Override
    public List<Person> findBycity(String city) throws SystemException {
     ...
     */
    @Override
    public List<Person> findBycity(String city, int start, int end)
        throws SystemException {
    ...
    public List<Person> findBycity(String city, int start, int end,
        ...
        if ((list != null) && !list.isEmpty()) {
            for (Person person : list) {
                if (!Validator.equals(city, person.getCity())) {
                    list = null;
     ...
     */
    @Override
    public Person findBycity_First(String city,
        OrderByComparator orderByComparator)
        throws NoSuchPersonException, SystemException {
        Person person = fetchBycity_First(city, orderByComparator);
     ...
     */
    @Override
    public Person fetchBycity_First(String city,
        OrderByComparator orderByComparator) throws SystemException {
        List<Person> list = findBycity(city, 0, 1, orderByComparator);
     ...
     */
    @Override
    public Person findBycity_Last(String city,
        OrderByComparator orderByComparator)
        throws NoSuchPersonException, SystemException {
        Person person = fetchBycity_Last(city, orderByComparator);
     ...
     */
    @Override
    public Person fetchBycity_Last(String city,
        OrderByComparator orderByComparator) throws SystemException {
        ...
        List<Person> list = findBycity(city, count - 1, count, orderByComparator);
     ...
     */
    @Override
    public Person[] findBycity_PrevAndNext(long personId, String city,
        OrderByComparator orderByComparator)
        throws NoSuchPersonException, SystemException {
        Person person = findByPrimaryKey(personId);
        ...
        try {
            ...
            array[0] = getBycity_PrevAndNext(session, person, city,
                    orderByComparator, true);

            array[1] = person;

            array[2] = getBycity_PrevAndNext(session, person, city,
                    orderByComparator, false);
    ...
    protected Person getBycity_PrevAndNext(Session session, Person person,
    ...
    public void removeBycity(String city) throws SystemException {
        for (Person person : findBycity(city, QueryUtil.ALL_POS,
                QueryUtil.ALL_POS, null)) {
            remove(person);
        }
    }
    ...
    @Override
    public Person updateImpl(net.opentrends.user.model.Person person)
        throws SystemException {
        person = toUnwrappedModel(person);
        ...
        if (isNew || !PersonModelImpl.COLUMN_BITMASK_ENABLED) {
            ...
            if ((personModelImpl.getColumnBitmask() &
                ...
                Object[] args = new Object[] { personModelImpl.getOriginalCity() };
                ...
                args = new Object[] { personModelImpl.getCity() };
    ...
    protected Person toUnwrappedModel(Person person) {
        ...
        personImpl.setSex(person.getSex());
        personImpl.setAge(person.getAge());
        personImpl.setCity(person.getCity());
        personImpl.setStatus(person.getStatus());
        personImpl.setStatusByUserId(person.getStatusByUserId());
        personImpl.setStatusByUserName(person.getStatusByUserName());
        personImpl.setStatusDate(person.getStatusDate());
    ...
    public void afterPropertiesSet() {
        String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
                    com.liferay.util.service.ServiceProps.get(
                        "value.object.listener.net.opentrends.user.model.Person")));
