...
public class AddressLocalServiceClpInvoker {
    ...
    public Object invokeMethod(String name, String[] parameterTypes,
        ...
        if (_methodName0.equals(name) &&
            ...
            return AddressLocalServiceUtil.addAddress((net.opentrends.user.model.Address) arguments[0]);
        }
        ...
        if (_methodName3.equals(name) &&
            ...
            return AddressLocalServiceUtil.deleteAddress((net.opentrends.user.model.Address) arguments[0]);
        }
        ...
        if (_methodName15.equals(name) &&
            ...
            return AddressLocalServiceUtil.updateAddress((net.opentrends.user.model.Address) arguments[0]);
        }
