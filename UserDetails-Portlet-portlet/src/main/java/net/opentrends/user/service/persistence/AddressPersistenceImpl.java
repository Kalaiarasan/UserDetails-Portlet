...
import net.opentrends.user.NoSuchAddressException;
import net.opentrends.user.model.Address;
import net.opentrends.user.model.impl.AddressImpl;
import net.opentrends.user.model.impl.AddressModelImpl;
...
public class AddressPersistenceImpl extends BasePersistenceImpl<Address>
    ...
    @Override
    public Address updateImpl(net.opentrends.user.model.Address address)
    ...
    protected Address toUnwrappedModel(Address address) {
        ...
        addressImpl.setPersonId(address.getPersonId());
    ...
    public void afterPropertiesSet() {
        String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
                    com.liferay.util.service.ServiceProps.get(
                        "value.object.listener.net.opentrends.user.model.Address")));
