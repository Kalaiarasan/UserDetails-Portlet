...
import net.opentrends.user.model.AddressClp;
import net.opentrends.user.model.PersonClp;
...
public class ClpSerializer {
        ...
        synchronized (ClpSerializer.class) {
            ...
            try {
                ...
                String portletPropsServletContextName = (String) getMethod.invoke(null,
                        "UserDetails-Portlet-portlet-deployment-context");
            ...
            if (Validator.isNull(_servletContextName)) {
                _servletContextName = "UserDetails-Portlet-portlet";
            }
    ...
    public static Object translateOutput(BaseModel<?> oldModel) {
        ...
        if (oldModelClassName.equals(
                    "net.opentrends.user.model.impl.AddressImpl")) {
            return translateOutputAddress(oldModel);
        }

        if (oldModelClassName.equals(
                    "net.opentrends.user.model.impl.PersonImpl")) {
    ...
    public static Throwable translateThrowable(Throwable throwable) {
        ...
        if (className.equals("net.opentrends.user.NoSuchAddressException")) {
            return new net.opentrends.user.NoSuchAddressException();
        }

        if (className.equals("net.opentrends.user.NoSuchPersonException")) {
            return new net.opentrends.user.NoSuchPersonException();
        }
