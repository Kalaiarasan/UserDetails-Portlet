...
public class AddressUtil {
    ...
    */
    public static void cacheResult(net.opentrends.user.model.Address address) {
    ...
    */
    public static void cacheResult(
        java.util.List<net.opentrends.user.model.Address> addresses) {
    ...
    */
    public static net.opentrends.user.model.Address create(long addressId) {
    ...
    * @throws net.opentrends.user.NoSuchAddressException if a address with the primary key could not be found
    * @throws SystemException if a system exception occurred
    */
    public static net.opentrends.user.model.Address remove(long addressId)
        throws com.liferay.portal.kernel.exception.SystemException,
            net.opentrends.user.NoSuchAddressException {
        return getPersistence().remove(addressId);
    }

    public static net.opentrends.user.model.Address updateImpl(
    ...
    /**
    * Returns the address with the primary key or throws a {@link net.opentrends.user.NoSuchAddressException} if it could not be found.
    *
    * @param addressId the primary key of the address
    * @return the address
    * @throws net.opentrends.user.NoSuchAddressException if a address with the primary key could not be found
    * @throws SystemException if a system exception occurred
    */
    public static net.opentrends.user.model.Address findByPrimaryKey(
        long addressId)
        throws com.liferay.portal.kernel.exception.SystemException,
            net.opentrends.user.NoSuchAddressException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static net.opentrends.user.model.Address fetchByPrimaryKey(
        long addressId)
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static java.util.List<net.opentrends.user.model.Address> findAll()
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    */
    ...
    public static AddressPersistence getPersistence() {
        if (_persistence == null) {
            _persistence = (AddressPersistence) PortletBeanLocatorUtil.locate(net.opentrends.user.service.ClpSerializer.getServletContextName(),
