 ...
 * {@link net.opentrends.user.service.impl.PersonLocalServiceImpl} and is the
...
public class PersonLocalServiceUtil {
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify this class directly. Add custom service methods to {@link net.opentrends.user.service.impl.PersonLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
     */
    ...
    */
    public static net.opentrends.user.model.Person createPerson(long personId) {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static net.opentrends.user.model.Person deletePerson(long personId)
    ...
    * @throws SystemException if a system exception occurred
    */
    public static net.opentrends.user.model.Person deletePerson(
        net.opentrends.user.model.Person person)
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    */
    ...
    public static net.opentrends.user.model.Person fetchPerson(long personId)
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static net.opentrends.user.model.Person fetchPersonByUuidAndCompanyId(
        java.lang.String uuid, long companyId)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().fetchPersonByUuidAndCompanyId(uuid, companyId);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static net.opentrends.user.model.Person fetchPersonByUuidAndGroupId(
    ...
    * @throws SystemException if a system exception occurred
    */
    public static net.opentrends.user.model.Person getPerson(long personId)
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static net.opentrends.user.model.Person getPersonByUuidAndCompanyId(
        java.lang.String uuid, long companyId)
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException {
        return getService().getPersonByUuidAndCompanyId(uuid, companyId);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static net.opentrends.user.model.Person getPersonByUuidAndGroupId(
        java.lang.String uuid, long groupId)
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static java.util.List<net.opentrends.user.model.Person> getPersons(
        int start, int end)
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static net.opentrends.user.model.Person updatePerson(
        net.opentrends.user.model.Person person)
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    */
    ...
    public static net.opentrends.user.model.Person updateStatus(long userId,
        long personId, int status,
        com.liferay.portal.service.ServiceContext serviceContext)
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException {
        return getService()
                   .updateStatus(userId, personId, status, serviceContext);
    }
