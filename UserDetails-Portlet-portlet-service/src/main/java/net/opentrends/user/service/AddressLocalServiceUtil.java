 ...
 * {@link net.opentrends.user.service.impl.AddressLocalServiceImpl} and is the
...
public class AddressLocalServiceUtil {
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify this class directly. Add custom service methods to {@link net.opentrends.user.service.impl.AddressLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
     */
    ...
    */
    public static net.opentrends.user.model.Address createAddress(
        long addressId) {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static net.opentrends.user.model.Address deleteAddress(
        long addressId)
    ...
    */
    ...
    public static net.opentrends.user.model.Address fetchAddress(long addressId)
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static net.opentrends.user.model.Address getAddress(long addressId)
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static java.util.List<net.opentrends.user.model.Address> getAddresses(
        int start, int end)
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static net.opentrends.user.model.Address updateAddress(
        net.opentrends.user.model.Address address)
        throws com.liferay.portal.kernel.exception.SystemException {
