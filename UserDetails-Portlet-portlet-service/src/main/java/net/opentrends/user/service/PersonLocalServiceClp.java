...
public class PersonLocalServiceClp implements PersonLocalService {
    ...
    public net.opentrends.user.model.Person addPerson(
        ...
        return (net.opentrends.user.model.Person) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public net.opentrends.user.model.Person getPerson(long personId)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName13,
                    _methodParameterTypes13, new Object[] { personId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<net.opentrends.user.model.Person> getPersons(
        ...
        return (java.util.List<net.opentrends.user.model.Person>) ClpSerializer.translateOutput(returnObj);
    }
