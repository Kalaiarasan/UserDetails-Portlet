...
/**
 * The base model interface for the Address service. Represents a row in the &quot;portal_Address&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation {@link net.opentrends.user.model.impl.AddressModelImpl} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link net.opentrends.user.model.impl.AddressImpl}.
 * </p>
 *
 * @author Ravi
 * @see Address
 * @see net.opentrends.user.model.impl.AddressImpl
 * @see net.opentrends.user.model.impl.AddressModelImpl
 * @generated
 */
